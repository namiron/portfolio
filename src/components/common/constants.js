...
export const chromeExtensionLink = `https://github.com/namiron/Block_plagin_extension`;

export const EXTRA_LINKS = [timerLink];
...
//------------------------------------image
export const EXTRA_IMAGE_ITEM = [timer];

export const IMAGE_ITEM = [staff, chat, store, extension, safari, quiz];
//------------------------------------image

//----------------------------------------------names

export const EXTRA_NAME_ITEM = [`timer`];
...
export const extraDataForMyWork = {
...
export const dataForMyWork = {
  ...
  Online_Chat: `Online Chat is a project for creating a fully-featured communication and chat application.<br><br>
  ...
  Chrome_Extension: `This is a complete, modular application consisting of three parts: a client, a server, and a browser extension. It is designed to block website streams by utilizing Chrome's protocols for content restriction. The application follows the Feature-Sliced Design (FSD) pattern to enhance modularity and streamline development.<br><br>
  <span>react.js</span> <span>typescript</span> <span>javascript</span> <span>nest js</span> <span>class-transformer</span> <span>class-validator</span> <span>cookie-parser</span> <span>clsx</span> <span>jest</span> <span>tanstack/react-query</span> <span>@types/chrome</span> 
   <span>docker</span> <span>postgreSQL</span> <span>prisma</span> <span>eslint</span> <span>prettier</span> <span>next js</span> <span>axios</span> <span>orval</span> <span>tailwindcss</span> <span>@crxjs</span>`,
